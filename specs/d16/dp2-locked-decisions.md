...
| SME-DP2-F4 | Audit scenario promotion | **Authorized 2026-04-24** via `specs/d16/bundle-v5-authorization-memo.md`. Scenario spec ready-to-insert; v4→v5 bump authorized with v4 revision_history backfill; static-plus-runtime audit mode per 2026-04-24 reframing (pure-function writer). Awaiting developer landing; flips to "Resolved and landed" on audit-pass. |
