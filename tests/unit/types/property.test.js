...
describe('createProperty', () => {
  ...
  it('sets all required fields', () => {
    const prop = createProperty({
      ...
      propertyConceptIri: 'fandaws:class/00000000-0000-0000-0000-000000000001/eyes',
      propertyLabel: 'eyes',
    ...
    expect(prop['owl:onProperty']).toBe('fandaws:class/00000000-0000-0000-0000-000000000001/eyes');
  ...
  it('defaults scope to concept-specific', () => {
    const prop = createProperty({
      ...
      propertyConceptIri: 'fandaws:class/00000000-0000-0000-0000-000000000002/x',
      propertyLabel: 'x',
  ...
  it('accepts a property value', () => {
    const prop = createProperty({
      ...
      propertyConceptIri: 'fandaws:class/00000000-0000-0000-0000-000000000003/legs',
      propertyLabel: 'legs',
      attachedTo: 'fandaws:class/4d6c7722-3b8d-554b-9506-9db415d16cda/dog',
      value: 4,
    });
  ...
  it('returns distinct objects per call', () => {
    const a = createProperty({
      id: 'a',
      propertyConceptIri: 'fandaws:class/00000000-0000-0000-0000-000000000004/a',
      propertyLabel: 'a',
      attachedTo: 'x',
    });
    const b = createProperty({
      id: 'b',
      propertyConceptIri: 'fandaws:class/00000000-0000-0000-0000-000000000005/b',
      propertyLabel: 'b',
      attachedTo: 'y',
    });
    expect(a).not.toBe(b);
  ...
  it('includes fandaws:propertyLabel field', () => {
    const prop = createProperty({
      ...
      propertyConceptIri: 'fandaws:class/00000000-0000-0000-0000-000000000006/fur',
      propertyLabel: 'fur',
      attachedTo: 'fandaws:class/4d6c7722-3b8d-554b-9506-9db415d16cda/dog',
    });
    expect(prop).toHaveProperty('fandaws:propertyLabel', 'fur');
    expect(prop['owl:onProperty']).toBe('fandaws:class/00000000-0000-0000-0000-000000000006/fur');
  });
});
